...
namespace WebSocketSharp
{
	public static class Ext
	{
		...
		internal static WebSocketSharp.Net.CookieCollection GetCookies(this NameValueCollection headers, bool response)
		{
			...
			return WebSocketSharp.Net.CookieCollection.Parse(text, response);
		}
		...
		{
			if (!(version == WebSocketSharp.Net.HttpVersion.Version10))
			{
				return value.isHttpMethod();
			}
			return value.isHttpMethod10();
		}
		...
		internal static bool KeepsAlive(this NameValueCollection headers, Version version)
		{
			...
			if (!(version < WebSocketSharp.Net.HttpVersion.Version11))
			{
