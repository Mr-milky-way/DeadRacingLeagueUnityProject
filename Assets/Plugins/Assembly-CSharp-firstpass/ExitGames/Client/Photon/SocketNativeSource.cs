...
namespace ExitGames.Client.Photon
{
	public class SocketNativeSource : IPhotonSocket
	{
		...
		[DllImport("PhotonSocketPlugin")]
		internal static extern IntPtr egconnectWithProtocol([MarshalAs(UnmanagedType.LPStr)] string address, byte connectionProtocol);

		[DllImport("PhotonSocketPlugin")]
		internal static extern IntPtr egconnectWithProtocols([MarshalAs(UnmanagedType.LPStr)] string address, byte connectionProtocol, [MarshalAs(UnmanagedType.LPStr)] string appID, [MarshalAs(UnmanagedType.LPStr)] string serializationProtocolString, byte serializationProtocolMajor, byte serializationProtocolMinor);
		...
		{
			((SocketNativeSource)((GCHandle)pUserData).Target).EnqueueDebugReturn((DebugLevel)debugLevel, str);
		}
