...
public class Room : RoomInfo
{
		...
		: base(roomName, null)
	{
		...
		masterPlatform = options.MasterPlatform;
	}
	...
	{
		return string.Format("Room: '{0}' {1},{2} {4}/{3} players.\ncustomProps: {5}", nameField, visibleField ? "visible" : "hidden", openField ? "open" : "closed", maxPlayersField, PlayerCount, base.CustomProperties.ToStringFull());
	}
}
