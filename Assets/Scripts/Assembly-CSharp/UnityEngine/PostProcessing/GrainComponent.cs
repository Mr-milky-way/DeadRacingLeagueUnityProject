namespace UnityEngine.PostProcessing
{
	public sealed class GrainComponent : PostProcessingComponentRenderTexture<GrainModel>
	{
		...
		public override bool active
		{
			get
			{
				if (base.model.enabled && base.model.settings.intensity > 0f && supportARGBHalf)
				{
		...
		{
			base.OnEnable();
			supportARGBHalf = SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf);
		}
