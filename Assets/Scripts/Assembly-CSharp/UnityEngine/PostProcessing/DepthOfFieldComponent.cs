...
namespace UnityEngine.PostProcessing
{
	public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
	{
		...
		private static Dictionary<RenderTextureFormat, bool> m_srtf_lut;
		...
		private RenderTextureFormat SelectFormat(RenderTextureFormat primary, RenderTextureFormat secondary)
		{
			if (m_srtf_lut == null)
			{
				m_srtf_lut = new Dictionary<RenderTextureFormat, bool>();
			}
			bool flag = false;
			RenderTextureFormat renderTextureFormat = primary;
			if (m_srtf_lut.ContainsKey(renderTextureFormat) ? m_srtf_lut[renderTextureFormat] : (m_srtf_lut[renderTextureFormat] = SystemInfo.SupportsRenderTextureFormat(renderTextureFormat)))
			{
