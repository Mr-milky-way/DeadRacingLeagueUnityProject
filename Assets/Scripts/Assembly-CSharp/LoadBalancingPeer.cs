...
internal class LoadBalancingPeer : PhotonPeer
{
	...
	public virtual bool OpGetRegions(string appId)
	{
		...
		return SendOperation(220, dictionary, sendOptions);
	}
	...
	protected internal bool OpSetPropertiesOfActor(int actorNr, Hashtable actorProperties, Hashtable expectedProperties = null, bool webForward = false)
	{
		...
		return SendOperation(252, dictionary, sendOptions);
	}
	...
	public virtual bool OpAuthenticate(string appId, string appVersion, AuthenticationValues authValues, string regionCode, bool getLobbyStatistics)
	{
		...
		if (authValues != null && authValues.Token != null)
		{
			...
			return SendOperation(230, dictionary, sendOptions);
		}
		...
		bool num = SendOperation(230, dictionary, sendOptions);
		if (!num)
		{
	...
	public virtual bool OpAuthenticateOnce(string appId, string appVersion, AuthenticationValues authValues, string regionCode, EncryptionMode encryptionMode, ConnectionProtocol expectedProtocol)
	{
		...
		if (authValues != null && authValues.Token != null)
		{
			...
			return SendOperation(231, dictionary, sendOptions);
		}
