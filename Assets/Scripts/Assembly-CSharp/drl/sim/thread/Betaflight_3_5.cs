...
{
	public class Betaflight_3_5 : FlightControllerInterface
	{
		private const string libraryName = "bf_3_5";
		...
		[DllImport("bf_3_5", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
