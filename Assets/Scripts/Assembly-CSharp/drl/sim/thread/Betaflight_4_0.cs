...
{
	public class Betaflight_4_0 : FlightControllerInterface
	{
		private const string libraryName = "bf_4_0";
		...
		public override byte FeedForwardTransition
		{
			get
			{
				return GetFeedForwardTransition();
			}
			set
			{
				SetFeedForwardTransition(value);
			}
		}
		...
		public override byte AntiGravityMode
		{
			get
			{
		...
		[DllImport("bf_4_0", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
		...
		[DllImport("bf_4_0")]
		public static extern byte GetAntiGravityMode();
		...
		[DllImport("bf_4_0")]
		public static extern byte GetFeedForwardTransition();
		...
		[DllImport("bf_4_0")]
		public static extern byte GetAbsControlCutoff();

		[DllImport("bf_4_0")]
		public static extern byte GetDtermFilter2Type();

		[DllImport("bf_4_0")]
		public static extern ushort GetDynLpfDtermMinHz();

		[DllImport("bf_4_0")]
		public static extern ushort GetDynLpfDtermMaxHz();

		[DllImport("bf_4_0")]
		public static extern byte GetLaunchControlMode();

		[DllImport("bf_4_0")]
		public static extern byte GetLaunchControlThrottlePercent();

		[DllImport("bf_4_0")]
		public static extern byte GetLaunchControlAngleLimit();

		[DllImport("bf_4_0")]
		public static extern byte GetLaunchControlGain();

		[DllImport("bf_4_0")]
		public static extern byte GetLaunchControlAllowTriggerReset();

		[DllImport("bf_4_0")]
		public static extern byte GetUseIntegratedYaw();

		[DllImport("bf_4_0")]
		public static extern byte GetIntegratedYawRelax();

		[DllImport("bf_4_0")]
		public static extern byte GetThrustLinearization();

		[DllImport("bf_4_0")]
		public static extern byte GetDMin(byte axis);

		[DllImport("bf_4_0")]
		public static extern byte GetDMinGain();

		[DllImport("bf_4_0")]
		public static extern byte GetDMinAdvance();

		[DllImport("bf_4_0")]
		public static extern byte GetMotorOutputLimit();

		[DllImport("bf_4_0")]
		public static extern sbyte GetAutoProfileCellCount();

		[DllImport("bf_4_0")]
		public static extern byte GetTransientThrottleLimit();

		[DllImport("bf_4_0")]
		public static extern byte GetTpaMode();
		...
		[DllImport("bf_4_0")]
		public static extern void SetAntiGravityMode(byte value);
		...
		[DllImport("bf_4_0")]
		public static extern void SetFeedForwardTransition(byte value);
		...
		[DllImport("bf_4_0")]
		public static extern void SetAbsControlCutoff(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetDtermFilter2Type(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetDynLpfDtermMinHz(ushort value);

		[DllImport("bf_4_0")]
		public static extern void SetDynLpfDtermMaxHz(ushort value);

		[DllImport("bf_4_0")]
		public static extern void SetLaunchControlMode(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetLaunchControlThrottlePercent(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetLaunchControlAngleLimit(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetLaunchControlGain(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetLaunchControlAllowTriggerReset(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetUseIntegratedYaw(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetIntegratedYawRelax(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetThrustLinearization(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetDMin(byte axis, byte value);

		[DllImport("bf_4_0")]
		public static extern void SetDMinGain(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetDMinAdvance(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetMotorOutputLimit(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetAutoProfileCellCount(sbyte value);

		[DllImport("bf_4_0")]
		public static extern void SetTransientThrottleLimit(byte value);

		[DllImport("bf_4_0")]
		public static extern void SetTpaMode(byte value);
