...
public class PickupItem : Photon.MonoBehaviour, IPunObservable
{
	...
	public void PunPickup(PhotonMessageInfo msgInfo)
	{
		...
		{
			Debug.Log("Ignored PU RPC, cause item is inactive. " + base.gameObject?.ToString() + " SecondsBeforeRespawn: " + SecondsBeforeRespawn + " TimeOfRespawn: " + TimeOfRespawn + " respawn in future: " + (TimeOfRespawn > PhotonNetwork.time));
			return;
		}
