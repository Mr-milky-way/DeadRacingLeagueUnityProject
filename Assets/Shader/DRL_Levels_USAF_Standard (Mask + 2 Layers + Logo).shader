Shader "DRL/Levels/USAF/Standard (Mask + 2 Layers + Logo)" {
	Properties {
		...
		[Space(20)] [Header(Layer 3 Properties . UV2)] _ColorLogo ("Color", Vector) = (1,1,1,1)
		_LogoTex ("Albedo (RGBA)", 2D) = "black" {}
	}
	...
	Fallback "DRL/Levels/USAF/Standard (Mask + 2 Layers)"
}