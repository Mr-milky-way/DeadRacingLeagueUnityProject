Shader "DRL/Levels/Championship Kingdom/Water" {
	Properties {
		...
		[Space(20)] [Header(River)] _ScrollSpeed ("Scroll Speed", Vector) = (1,0,0,0)
		[KeywordEnum(None, Red, Green, Blue)] _VertexColorMask ("Vertex Color Mask Channel", Float) = 0
	}
