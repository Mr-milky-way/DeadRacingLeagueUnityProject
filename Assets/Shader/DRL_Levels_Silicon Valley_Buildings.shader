Shader "DRL/Levels/Silicon Valley/Buildings" {
	Properties {
		[Header(PROPERTIES)] [Space(10)] _Color ("Color", Vector) = (1,1,1,1)
		_ColorR ("Color (Red)", Vector) = (1,1,1,1)
		_ColorG ("Color (Green)", Vector) = (1,1,1,1)
		_ColorB ("Color (Blue)", Vector) = (1,1,1,1)
		_ColorA ("Color (Alpha)", Vector) = (1,1,1,1)
