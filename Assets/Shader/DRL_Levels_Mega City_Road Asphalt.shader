Shader "DRL/Levels/Mega City/Road Asphalt" {
	Properties {
		[Header(MASK (UV3))] [Space(10)] _FXTileTex ("Wetness (R) Darkness (G)", 2D) = "black" {}
		...
		[Space(20)] [Header(DEETAIL MAPS (UV1))] [Space(10)] _DetailTexNorIntensity ("Normal", Range(0, 2)) = 1
		_DetailTexAlb ("Albedo (RGB)", 2D) = "gray" {}
		[NoScaleOffset] [Normal] _DetailTexNor ("Normal (RGB)", 2D) = "bump" {}
		[Space(20)] [Header(MARKS MAPS (UV3))] [Space(10)] _MarksTexAlbIntensity ("Albedo", Range(0, 1)) = 0
