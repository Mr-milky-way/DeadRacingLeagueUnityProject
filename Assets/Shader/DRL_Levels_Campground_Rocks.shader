Shader "DRL/Levels/Campground/Rocks" {
	Properties {
		[Header(MAIN MAPS (UV1))] [Space(10)] _Color ("Color", Vector) = (1,1,1,1)
		_Metallic ("Metallic", Range(0, 1)) = 0
		_Smoothness ("Smoothness", Range(0, 1)) = 0
		_NormalIntensity ("Normal", Range(0, 1)) = 1
		...
		[Space(20)] [Header(GLOBAL DETAIL MAPS (UV1))] [Space(10)] _DetNormalIntensity ("Normal", Range(0, 1)) = 1
		_DetAlbedoTex ("Albedo (RGB)", 2D) = "white" {}
		[NoScaleOffset] [Normal] _DetNormalTex ("Normal (RGB)", 2D) = "bump" {}
		[Space(20)] [Header(MASK DETAIL MAPS (UV1))] [Space(10)] _MaskColor ("Color", Vector) = (1,1,1,1)
		_MaskNormalIntensity ("Normal", Range(0, 1)) = 1
		...
		[Space(20)] [Header(WATER LEVEL)] [Space(10)] _WaterMetallic ("Metallic", Range(0, 1)) = 1
		_WaterSmoothness ("Smoothness", Range(0, 1)) = 1
		_WaterLevel ("Fade Level", Float) = 0
		_WaterRange ("Fade Range", Float) = 10
		_WaterExp ("Fade Exp", Range(1, 20)) = 1
	}
