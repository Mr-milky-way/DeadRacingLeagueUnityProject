Shader "DRL/Levels/Campground/Cars" {
	Properties {
		[Header(PROPERTIES)] [Space(10)] _Color ("Color", Vector) = (1,1,1,1)
		_PaintingColor ("Painting Color", Vector) = (1,1,1,1)
		_PaintingSmoothness ("Painting Smoothness", Range(0, 1)) = 1
		_PaintingMetallic ("Painting Metallic", Range(0, 1)) = 1
		[Space(20)] [Header(MAIN MAPS)] [Space(10)] _MainTex ("Albedo (RGB) Painting Mask (A)", 2D) = "white" {}
