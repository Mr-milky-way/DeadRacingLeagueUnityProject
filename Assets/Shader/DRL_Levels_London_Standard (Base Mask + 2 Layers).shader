Shader "DRL/Levels/London/Standard (Base Mask + 2 Layers)" {
	Properties {
		[Header(Base Color and Mask Properties . UV0 . Fallback Detail Albedo)] _BaseIntensity ("Base Intensity", Range(0, 1)) = 0.5
		_MaskPower ("Mask Power", Range(1, 5)) = 1
		_MaskAdd ("Mask Add", Range(0, 100)) = 1
		[NoScaleOffset] _DetailAlbedoMap ("Base Color (RGB) Mask (A)", 2D) = "white" {}
