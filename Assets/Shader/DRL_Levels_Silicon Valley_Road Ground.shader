Shader "DRL/Levels/Silicon Valley/Road Ground" {
	Properties {
		...
		_RoadTexNorIntensity ("Normal", Range(0, 2)) = 1
		_RoadTexAlb ("Albedo (RGB)", 2D) = "white" {}
		[NoScaleOffset] [Normal] _RoadTexNor ("Normal (RGB)", 2D) = "bump" {}
		[Space(20)] [Header(DETAIL MAPS (UV2))] [Space(10)] _DetailTexNorIntensity ("Normal", Range(0, 2)) = 1
		_DetailTexSmoothness ("Smoothness", Range(0, 1)) = 1
		_DetailTexAlb ("Albedo (RGB) Smoothness (A)", 2D) = "gray" {}
